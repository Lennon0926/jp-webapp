...
def IP_420_qtr(request): # Cambia
    ...
    #     DAO().insert_forms(
    #         data_path="data/cuestionarios/balanza_de_pagos/JP_420_qrt.csv", # Cambia
    #         dtypes={
    ...
    return render(request, "forms/quaterly/ingreso_neto_qtr/IP_420_qtr.html") # Cambia
