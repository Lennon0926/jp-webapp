...
def IP_310b_qtr(request): # Cambia
    ...
    #     DAO().insert_forms(
    #         data_path="data/cuestionarios/balanza_de_pagos/JP_310b_qrt.csv", # Cambia
    #         dtypes={
    ...
    return render(request, "forms/quaterly/ingreso_neto_qtr/IP_310b_qtr.html") # Cambia
