...
urlpatterns = [
    ...
    re_path(r"^IP-530-inmobiliaria-y-arrendamientos-qtr/$", views.IP_530_qtr, name="IP-530-qtr"),
    re_path(r"^IP-540-servicios-profesionales-tecnicos-y-cientificos-qtr/$", views.IP_540_qtr, name="IP-540-qtr"),
    re_path(r"^IP-540S-servicios-administrativos-y-de-apoyo-qtr/$", views.IP_540s_qtr, name="IP-540S-qtr"),
    re_path(r"^IP-540a-publicidad-y-servicios-relacionados-qtr/$", views.IP_540a_qtr, name="IP-540a-qtr"),
    re_path(r"^IP-540v-veterinarios-y-otros-servicios-de-animales-qtr/$", views.IP_540v_qtr, name="IP-540v-qtr"),
    re_path(r"^IP-540j-administracion-de-empresas-qtr/$", views.IP_540j_qtr, name="IP-540j-qtr"),
    re_path(r"^IP-540p-organizacion-de-viajes-y-servicios-de-reservacion-qtr/$", views.IP_540p_qtr, name="IP-540p-qtr"),
    re_path(r"^IP-610-servicios-de-educacion-qtr/$", views.IP_610_qtr, name="IP-610-qtr"),
    re_path(r"^IP-620-servicios-de-salud-qtr/$", views.IP_620_qtr, name="IP-620-qtr"),
    re_path(r"^IP-710-arte-entretenimiento-y-recreacion-qtr/$", views.IP_710_qtr, name="IP-710-qtr"),
    ...
    re_path(r"^JP-560-63210-seguros-domesticos-propiedad-contingencia-qtr/$", views.JP_560_63210_qtr, name="JP-560-63210-qtr"),
